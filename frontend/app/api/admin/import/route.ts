...
const defaultProducts = [
  {
    ...
    model3ds: ['/models/sofa-modern.glb'],
  ...
  },
  {
    ...
    model3ds: ['/models/dining-set.glb'],
    category: 'dining',
    roomType: 'Dining',
  ...
  },
  {
    ...
    model3ds: ['/models/office-desk.glb'],
    category: 'office',
    roomType: 'Office',
  ...
  },
  {
    ...
    model3ds: ['/models/coffee-table.glb'],
    category: 'living-room',
    roomType: 'Living Room',
  ...
  },
  {
    ...
    imageUrl: '/images/products/bed-frame.jpg',
    images: ['/images/products/bed-frame.jpg'],
    model3ds: ['/models/bedroom-set.glb'],
    category: 'bedroom',
    roomType: 'Bedroom',
  ...
  },
  {
    ...
    imageUrl: '/images/products/armchair.jpg',
    images: ['/images/products/armchair.jpg'],
    model3ds: ['/models/office-chair.glb'],
    category: 'office',
    roomType: 'Office',
